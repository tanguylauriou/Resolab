...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($file_tmp, $upload_path)) {
        ...
        $query = "INSERT INTO livrables (nom, public_cible, fichier, type_document, description, langue) VALUES (:nom, :public_cibles, :fichier_url, :type_document, :description, :langue)";
