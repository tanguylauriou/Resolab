...
<body>
    ...
    if (isset($_SESSION['utilisateur_connecte'])) {
        echo '<a href="../fr/ajouter_actualite.php" class="bouton-ajouter-actualité">Ajouter une actualité</a>';
    }
    ?>
...
$query = "SELECT * FROM actualites WHERE langue = 'fr' ORDER BY id DESC";
