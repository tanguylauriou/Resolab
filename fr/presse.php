...
function modifierArticle(articleId) {
        window.location.href = 'modifier_presse.php?id=' + articleId;
    }
</script>
<script>
function supprimerArticle(articleId) {
    if (confirm("Êtes-vous sûr de vouloir supprimer cet article ?")) {
        ...
        xhr.open("POST", "traitement_supression_article_presse.php", true);
...
<script src="btn-langue.js"></script>
    ...
    <?php
        ...
        echo ' <a href="ajouter_presse.php" class="bouton-ajouter-article">Ajouter un article</a>';
        }
        ?>
