    ...
    <div class="menu-button">
        ...
        <nav>
            <ul>
                ...
                ?>
                <li><a class="head" href="../fr/projet.php" aria-label="En savoir plus sur le projet ResoLab">Projet</a></li>
                <li><a class="head" href="../fr/actualite.php" aria-label="Les actualitées de resolab">Actualité</a></li>
                <li><a class="head" href="../fr/blog.php" aria-label="les dernier post de resolab">Blog</a></li>
                <li><a class="head" href="../fr/livrable.php" aria-label="les livrables du projet ResoLab">Livrables</a></li>
                <li><a class="head" href="../fr/partenaire.php" aria-label="les partenaires du projet ResoLab">Partenaires</a></li>
                <li class="lang-dropdown">
    <a class="dropbtn" id="languageButton">
        <img src="../image-logoSite/drapeau-francais.png" alt="Français" class="flag-img">
    </a>
