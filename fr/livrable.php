...
<head>
    ...
    <title>Résolab Europe - Livrables</title>
...
<body>
    <main>
        ...
        echo '<a href="ajouter_livrable.php" class="bouton-ajouter-livrable">Ajouter un livrable</a>';
        }
        ?>
...
<div class="liste-livrable">
    ...
    $query = "SELECT * FROM livrables WHERE langue = 'fr' ORDER BY id DESC";
