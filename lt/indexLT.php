...
<main>
    ...
    <section class="actualité-container">
        ...
        $query = "SELECT * FROM actualites WHERE langue = 'lt' ORDER BY id DESC LIMIT 3";
        ...
        <section id="blog">
            ...
            <section class="articles-container">
                ...
                $query = "SELECT * FROM articles WHERE langue = 'lt' ORDER BY id DESC LIMIT 3"; // Récupère les 3 derniers articles
                $result = $connexion->query($query);
