    ...
    <div class="menu-button">
        ...
        <nav>
            <ul>
                ...
                ?>
                <li><a class="head" href="../lt/projet.php" aria-label="En savoir plus sur le projet ResoLab">Projet</a></li>
                <li><a class="head" href="../lt/actualite.php" aria-label="Les actualitées de resolab">Actualité</a></li>
                <li><a class="head" href="../lt/blog.php" aria-label="les dernier post de resolab">Blog</a></li>
                <li><a class="head" href="../lt/livrable.php" aria-label="les livrables du projet ResoLab">Livrables</a></li>
                <li><a class="head" href="../lt/partenaire.php" aria-label="les partenaires du projet ResoLab">Partenaires</a></li>
                <li class="lang-dropdown">
    <a class="dropbtn" id="languageButton">
        <img src="../image-logoSite/drapeau-lituanien.png" alt="lituanien" class="flag-img">
    </a>
