...
<head>
    ...
    function modifierArticle(articleId) {
        window.location.href = '../fr/modifier_article.php?id=' + articleId;
    }
</script>
<script>
function supprimerArticle(articleId) {
    if (confirm("Êtes-vous sûr de vouloir supprimer cet article ?")) {
        ...
        xhr.open("POST", "../fr/traitement_suppression_article.php", true);
...
<body>
    <main>
        ...
        echo ' <a href="../fr/ajouter_article.php" class="bouton-ajouter-article">Ajouter un article</a>';
        }
        ?>
        ...
        <div class="liste-articles">
            ...
            $query = "SELECT * FROM articles WHERE langue = 'lt' GROUP BY id DESC";
