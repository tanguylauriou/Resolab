    ...
    <div class="menu-button">
        ...
        <nav>
            <ul>
                ...
                ?>
                <li><a class="head" href="../en/projet.php" aria-label="En savoir plus sur le projet ResoLab">Project</a></li>
                <li><a class="head" href="../en/actualite.php" aria-label="Les actualitées de resolab">Actualité</a></li>
                <li><a class="head" href="../en/blog.php" aria-label="les dernier post de resolab">Blog</a></li>
                <li><a class="head" href="../en/livrable.php" aria-label="les livrables du projet ResoLab">Livrables</a></li>
                <li><a class="head" href="../en/partenaire.php" aria-label="les partenaires du projet ResoLab">Partenaires</a></li>
                <li class="lang-dropdown">
    <a class="dropbtn" id="languageButton">
        <img src="../image-logoSite/drapeau-anglais.png" alt="anglais" class="flag-img">
    </a>
