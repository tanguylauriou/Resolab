...
// Fermer la connexion à la base de données (elle se ferme automatiquement à la fin du script)
// $connexion = null; // Vous n'avez pas besoin de le fermer explicitement
