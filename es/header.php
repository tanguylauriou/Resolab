    ...
    <div class="menu-button">
        ...
        <nav>
            <ul>
                ...
                ?>
                <li><a class="head" href="../es/projet.php" aria-label="En savoir plus sur le projet ResoLab">Projet</a></li>
                <li><a class="head" href="../es/actualite.php" aria-label="Les actualitées de resolab">Actualité</a></li>
                <li><a class="head" href="../es/blog.php" aria-label="les dernier post de resolab">Blog</a></li>
                <li><a class="head" href="../es/livrable.php" aria-label="les livrables du projet ResoLab">Livrables</a></li>
                <li><a class="head" href="../es/partenaire.php" aria-label="les partenaires du projet ResoLab">Partenaires</a></li>
                <li class="lang-dropdown">
    <a class="dropbtn" id="languageButton">
        <img src="../image-logoSite/drapeau-espagnol.png" alt="espagnol" class="flag-img">
    </a>
